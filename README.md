 ...
 * ~~На данный момент пребывает в плачевном состоянии, поскольку админ обновляет базу только вручную и крайне редко, а прознавшие про сайт художники свои работы высылают донорам индивидуально и адресно~~ В последние месяцы всё не так уж  плохо, дампы тепреь обновляются весьма оперативно, а на инфинитаче люди делятся полученным от доноров добром.
...
* [Ычан](http://iichan.hk/fr/) – живая пушистая доска на Ычане.
* [Доброчан](http://dobrochan.com/fur/) – чуть менее живая пушистая доска на Доброчане. 
