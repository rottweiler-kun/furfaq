...
При переходе по прямой ссылке на [yiff.party](https://yiff.party) показывают ~~хуй~~ заглушку, дабы отвадить копирастов, гуглботов и прочих мимокрокодилов. Для получния доступа к контенту следует выполнить небольшой квест: зайти фурёвую доску инфинитача, открыть официальный тред yiff.party и щёлкнуть по специальной ссылке, дабы перейти на сайт с определённым referer-ом.

Проблема в том, что официальный тред был бесславно просран и улетел в бамплимит, а админ yiff.party (*~~хуй~~ bui*), настроив автоматический граббер, периодически грозиться стать мухожуком и не торопится фиксить реферер. 

Однако при наличии прямых лап до вожделенного содержимого рипов всё же можно добраться благодаря [гайду в неофициальном треде](https://8ch.net/furry/res/580157.html#q600981). 
