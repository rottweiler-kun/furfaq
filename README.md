...
* https://fri-gate.org – расширение для браузера.
...
* https://www.torproject.org/download/download-easy.html.en – браузер с интегрированным TOR-ом. Для пущей анонимности и безопасности по умолчанию отключены скрипты, Flash и прочие привычные вещи, так что многие фичи на сайтах перестают нормально работать.

* http://antizapret.prostovpn.org – дешёвый и сердитый способ заворачивать траффик к заблокированным ресурсам на внешний прокси прописыванием настроек в браузере. 
