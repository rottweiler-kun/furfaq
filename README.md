...
Сам поиск осуществляется стандартным образом - в поле для поиска вписываются вручную или указываются теги (есть подсказка): **[Rottweiler, Male](https://www.sofurry.com/browse/search?search=Rottweiler%2C+Male)**. Если нужно исключить какой-нибудь тег из результатов поиска, он указвается в запросе после восклицательного знака: **[Rottweiler, Male, !Female](https://www.sofurry.com/browse/search?search=Rottweiler%2C+Male%2C+%21Female)**.
...
* Теги иерархичны, т.е. работы с тегом **Rottweiler** можно найти также по запросам **Dog** и **Canine**, однако работает эта иерархичность почему-то далеко не всегда. Так что не ленись расширять или сужать поисковые запросы, анон.
* Хорошей идеей будет указание в настройках профиля во вкладке "Account" ~~степени своей ебанутости~~ максимального уровня допустимого контента. Так можно лицам с тонкой душевной организацией отключить показ гуро, а любители гурятины наоборот смогут-таки её отыскать.
