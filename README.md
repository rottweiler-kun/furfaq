...
* **бэддрэгон** (Bad Dragon) – знаменитый онлайн-дилдомагазин. Образцы продукции см. в соответвующем пункте раздела 1.1.
* **скейли** (scaly) – чешуйчатые, т.е. рептилии и драконы.
* **ФА** (FA) – [FurAffinity](https://furaffinity.net), крупная артгалерея.
...
* **глутамат** (621) – [E621.NET](https://e621.net), крупнейшая каталогизированная коллекция фурри-~~прона~~арта, названная в честь добавки - усилителя вкусовых ощущений.
* **софа** (SF) – [SoFurry](https://sofurry.com), ещё одна крупная галерея и по совместительству библиотека.
* **_** () – 
* **_** () – 
* **_** () – 
* **_** () – 
