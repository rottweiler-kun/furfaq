 ...
 * [The Big ImageBoard](http://tbib.org/) – метагалерея, пиздящая контент с других буру-ресурсов. Интересна в первую очередь тем, что боты регулярно пиздят арты с глутамата, так что база пикч во многом повторяется, а в качестве бонуса оставются потёртые с глутамата DNP-шные картинки.
...
* [Йифф.ру](http://yiff.ru) – застрявшая во времени галерея спижженого арта начала 2000-х, знатный источник попоболи зарубежных художников. В соотвествии с духом времени на сайте были СЕКРЕТНЫЕ ГАЛЕРЕИ, для получения ссылок на которые нужно было проходить аудиенцию у сайтодержателей.
 * [Форум](http://yiff.ru/forum.yiff) единственное живое место на давно умершем теле сайта. Был и остаётся основным поставщиком  эпичных драм, знаменит анальными админами и модераторами с раздутым ЧСВ и не менее ебанутыми ~~клиентами~~ посетителями. При этом в соседних ветках может вполне себе соседствать треш/угар/содомия и вполне цивильное обсуждение нейтральных вопросов. Древний движок вайпает через полгода любые прикреплённые к сообщениям файлы, отчего чтение древних тредов сродни экскурсии по сожжённой Александрийской библиотеке.
...
* [FurTails - Пушистые хвосты](https://furtails.ru) – библиотека фурёвых рассказов. Состоит преимущественно из переводных рассказов, понадёрганных отовсюду фанфиков и графоманства зарегистрированных пользователей. Есть неплохие вещи. Можно публиковаться, получать в ответ критику, швыряться говном на форуме и зарабатывать ~~бан~~ ачивки. 
...
Сам поиск осуществляется стандартным образом - в поле для поиска вписываются вручную или указываются теги (есть поисковая подсказка): **_[Rottweiler, Male](https://www.sofurry.com/browse/search?search=Rottweiler%2C+Male)_**. Если нужно исключить какой-нибудь тег из результатов поиска, он указвается в запросе после восклицательного знака: **_[Rottweiler, Male, !Female](https://www.sofurry.com/browse/search?search=Rottweiler%2C+Male%2C+%21Female)_**.

В результатах поиска намешаны в общую кучу картинки, рассказы, журналы, музыка и прочее. При желании можно выбрать только определённый тип контента с помощью вкладок вверху в правой части страницы, а в левой - указать указать режим сортировки и диапазон найденного контента (от няшного до ультрапиздецового).

Пара важных моментов, касающихся поиска:
* SoFurry индексируется поисковиками, однако незарегистированным пользователям NSFW-работы не отображаются, хотя по прямым ссылкам иногда можно просматривать их в гостевом режиме.
...
* Если ищется контент с каким-то специфическим содержанием, имеет смысл проверить так называемые [группы](https://www.sofurry.com/groups/) - сообщества пользователей по интересам - на страницах которых часто собрана коллекция работ соотвествующей тематики.
...
* **[TOR Browser](https://www.torproject.org/download/download-easy.html.en)** – браузер с интегрированным TOR-ом. Для пущей анонимности и безопасности по умолчанию отключены скрипты, Flash и прочие привычные вещи, так что многие фичи на сайтах перестают нормально работать.
