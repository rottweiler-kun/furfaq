 ...
 * [Версия, адаптированная под мобильные устройства](http://e621.s.co/).
 ...
 * ~~На данный момент пребывает в плачевном состоянии, поскольку админ обновляет базу только вручную и крайне редко, а прознавшие про сайт художники свои работы высылают донорам индивидуально и адресно~~ ~~В последние месяцы всё не так уж  плохо, дампы теперь обновляются весьма оперативно, а на инфинитаче люди делятся полученным от доноров добром.~~ После введения Патреоном в июле 2016 года авансовой системы подписки бесплатная халява закончилась, хотя сграбленный к этому времени архив всё ещё представляет определённую ценность.
 * ~~С недавнего времени повесили устрашающий дисклеймер от мимокрокодилов и пускают на сайт только по логину/паролю, который периодически меняется и выкладывается в официальный тред на инфинитаче.~~ На сайт пускали только по реферреру с официального треда на инфинитаче, который был бесславно просран и улетел в бамплимит. Однако при наличии прямых лап и пары дополненй до браузера добраться до вожделенного архива всё же можно благодаря [гайду в неофициальном треде](https://8ch.net/furry/res/580157.html#q600981).
...
* [∞chan](http://8ch.net/furry) – по стилю напоминает лулзнет и даже отчасти реддит, но с большим уклоном в пикчи, а не в драму. Славится охуительными историями и высокоинтеллектуальными дискуссиями, которые и в самом деле интересно читать. Постепенно теснит скатывающийся в политоту LULZ.net и вайпнутый U18Chan с позиции главной фурёвой доски всея интернета.
...
Все крупные магазины принимают Российские карты и шлют стафф в Россию через **USPS Priority**, что по понятным причинам обходится недёшево (в зависимости от веса и габаритов стоимость доставки варьирует в диапазоне 50...150$).

* [Rabbit Valley](https://www.rabbitvalley.com/) – крупнейший ориентированный на фуррей интернет-магазин. Продают книги и журналы, диски, принты, шмотки и кучу всего прочего, в том числе электронным контент. Ассортимент крайне разнообразный, от чисто фурёвого до MLP и менстрим-комиксов; в продаже есть как новинки, так реликты из далёких 1990-х годов, изготовленные в десяти экземплярах на университетском ксероксе. Предлагают воннаби-авторам посреднические услуги по издательству, продаже и промоушену их трудов; особо упоротым экземплярам предлагают услуги редактора-корректора. Магазин удобен в первую очередь тем, что можно купить ~~колу и пепси в одном автомате~~ продукцию самых разных издательств, хотя нереко приходится ждать пока завезут новую партию распроданного товара или пока владельцы вернутся с очередной фуренции. Из-за самописного платёжного шлюза, не предусматривающего в частности указания *CVV*/*CVC* кода, могут возникать проблемы с оплатой картами особенно параноидных банков.
 * Базируется в Лас-Вегасе, в практически полностью автоматизированном режиме управляется двумя людьми (плюс сторонний (веб-)программист и завсклад-по-вызову в другом штате) в свободное от основной работы время – учитесь, как нужно делать бизнес!
* [Furplanet](https://furplanet.com/shop) – 
* [SofaWolf Press](https://www.sofawolf.com/shop) – монобрендовый магазин одноимённого издательства из Миннесоты, специализируется преимущественно на художественной литературе. Негласно счтиается дохуя элитарным издательством, ибо там публикуются всякие Кайлы Голды, обложки к книгам рисуют всяки Блотчи, а опубликованные издания получают овердохуя всяких премий и наград. Многие новинки в течение определённого времени продают эксклюзивно. В каталоге по непонятным причинам годами остаются висеть в статусе *Out of Stock* старые книги и журналы - видимо, для истории.
 * По умолчанию adult-контент скрыт и включается неприметным переключателем в правом верхнем углу.
* [BlackPaw](https://www.blackpaw.de) – европейский реселлер из Эссена (Германия), специализирующийся на продукции SofaWolf и мерчандайза, связанного с EuroFurence. Для живущих в Западной Европе является неплохой альтернативой заказу из-за океана; для восточных соседей выгода малозаметна из-за нивелирования различий стоимости доставки из-за курса валют. Заказы выполняют крайне неторопливо, т.к. основная задача - снабжать свежим стаффом посетителей Еврофуренции.
...
>* https://erasexa.com - судя по всему, оригинальные модели только "стаффорд" и "чарли" (найти прототипы этих моделей на зарубежных сайтах не удалось), остальные - копии вышеперечисленных изготовителей, но сделанные грубее, мелкие детали сильно упрощены и изменены.
