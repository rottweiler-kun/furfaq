...
Тащемта основы описаны в [хелпе](http://www.pixiv.net/help.php#3-3) и не отличаются от поиска на любой пикчепомойке.
Засада в том, что англоязычные теги гордые самураи практчески не используют, поэтому поиск по ним желаемого результата не даст - равно как и по англоязычным никам художников, которые здесь откликаются лишь на аборигенские названия. Поэтому залогом успеха является знание волшебных иероглифов, причём если выучить что "**ケモノ**" это [фурри](http://dic.pixiv.net/a/furry) ещё можно, то для других тегов придётся прибегать к специальным словарям навроде [такого](http://naughtyjester.tumblr.com/post/119904403350/list-of-pixiv-tags) или [эдакого](http://graphicsexualhorror.tumblr.com/post/51023977906/ref-list-of-kinknsfw-related-pixiv-tags).
