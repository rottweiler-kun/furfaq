...
> Далеко не все VPN-провайдеры ~~одинаково полезны~~ стремятся во что бы то ни стало сохранить приватность своих пользователей, поэтому перед использованием рекомендуется ознакомиться с общими принципами выбора VPN-сервиса и прочими нюансами как на [русскоязычной](https://privacytools.ru/), так и на [англоязычной](https://www.privacytools.io/providers/) страницах. Они друг от друга незначительно, но всё же отличаются – очевидно, с учётом закидонов местных властей и сценариев использования VPN.
